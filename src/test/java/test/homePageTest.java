...
public class homePageTest extends Base {
	...
	public void VerifyGrantTotal() {
		extentTest = extent.startTest("VerifyGrantTotal");
		float price = homePage.getGrantToatal("mostafa.001@test.com", "12345678");
		if(price<=350.0) {Assert.assertTrue(true);}
		else{Assert.assertTrue(false);}	
	}
	
//	@Test(dependsOnMethods = { "VerifyGrantTotal" })
//	public void VerifyOrderHasBeenReceived() {
//		extentTest = extent.startTest("VerifyOrderHasBeenReceived");	
//		
//	}
